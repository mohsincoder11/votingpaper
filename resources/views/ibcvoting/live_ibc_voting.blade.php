	...
	<div class="container">
		<div class="slim-pageheader">
			<ol class="breadcrumb slim-breadcrumb">
				...
				<li class="breadcrumb-item">Live IBC Voting</li>
			</ol>
		...
		<div class="section-wrapper mg-t-5">
			...
			<div class="table-wrapper">
				<table id="ibc_table" class="table">
					<thead>
						<tr>
							<th ></th>
...
var send_class='';
					...
					$("#ibc_table_row").append(
						'<tr><td>'+b.id+'</td><td><b>'+b.ibcid+'</b></td><td>'+b.votingtitle+'</td><td>'
						+votestartdate+' '+b.votestarttime+'</td><td>'+voteenddate+' '+b.voteendtime+'</td><td><b>'+b.total_voter+'</b></td><td><b>'+remaining_voter+'</b></td><td><a href="#" class="btn btn-primary btn-sm rounded-circle sendnotification tooltip2 '+send_class+'" id=' 
 ...
 language: {
 	...
 	lengthMenu: '_MENU_ items/page',
        ...
        $("#ibc_table_row").on('click','.sendnotification',function(){
        	var ibc_id=$(this).attr('id');
				$('#loaderpage').show();
        	$.ajax({
        		type: "get",
        		url: "{{Route('send_remaining_ibc_voter_notification')}}",
        		data: {ibc_id:ibc_id}, 
        		dataType:'json',
        		success:function(data) {
        			//console.log(data);
