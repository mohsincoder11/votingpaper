      ...
      success: function(data) {
        ...
        if (data.length > 0) {
         ...
         var remaining=b.total_voter-b.voted;
           ...
           b.ibcid + '</h3>              <div class="row">                <div class="col">                  <label class="tx-12">IBC Voting Title</label>                  <p>' +
           ...
           b.voted+'</p>                </div>                <div class="col">                  <label class="tx-12">Remaining Voter</label>                  <p>'+remaining+'</p>                </div>              </div>   <p class="mg-b-0"><a href="{{url("view_ibc_result")}}/'+b.id+'"  class="btn '+btn_class+' btn-sm btn-block tx-14"> <b> '+btn_text+'</b> </a></p>            </div>          </div>');
       })
        } else {
