...
<div class="slim-mainpanel">
	<div class="container">
		...
		<input type="hidden" value="{{$singledata->entity}}" id="entitytypeedit">
		<input type="hidden" value="{{$singledata->status}}" id="election_status">
			...
			<div id="wizard2">
				...
				<section>
					<div class="table-wrapper">
						<table id="entitytable_class" class="table display entitytable_class responsive nowrap">
							<thead>
								<tr>
					...
					<div class="row pt-2">	
												<input type="hidden" value="1" id="createpollsubmit">
						                            @if (auth()->user()->role == 1 || auth()->user()->role == 2)<div class="col-lg-4">
					...
					<div class="row">
						<div class="col-lg-4">
							<div class="form-group mg-b-10-force">
								...
								<input class="form-control" value="{{$singledata->votingtitle}}" placeholder="Enter Voting Title" name="votingtitle" id="votingtitle" type="text" required="">
						...
						<div class="col-lg-2">
							<div class="form-group mg-b-10-force">
								...
								<input id="votestartdate" value="{{$singledata->votestartdate}}" min="{{date('Y-m-d')}}" class="form-control check_time_class" name="votestartdate" type="date" required="">
					...
					<div class="row">
						...
						<div class="col-lg-4">
							<div class="form-group mg-b-10-force">
								...
								<input id="meetingtitle" class="form-control" value="{{$singledata['meetingtitle']}}" name="meetingtitle" type="text" placeholder="Enter Meeting Title">
						...
						<div class="col-lg-4">
							<div class="form-group mg-b-10-force">
								...
								<input id="meetingdate" value="{{$singledata['meetingdate']}}" class="form-control" name="meetingdate" type="date" >
				...
				<section>
					...
					<div class="row pt-2">
						...
						<div class="col-lg-4">
							...
							<input type="hidden" value="{{$singledata->status}}" name="election_status2">
							...
							<div class="form-group mg-b-10-force">
								...
								<div class="row">
									...
									<div class="col-md-4">
										<div class="form-group mg-b-10-force ">
											<button type="button" id="election_voterfile_upload" class="bt btn-primary" style="padding:10px 8px 7px 10px; "><i class="fas fa-upload"></i> &nbsp;&nbsp;Upload</button>
										</div>
								...
								<b><label for="" style="color: red" id="file_ampty"></label></b>
							</div>
							<input type="hidden" value="{{$singledata->id}}" id="electionidvoterlist" name="resolutionidvoterlist">

						</div><!-- col-4 -->
						<div class="col-lg-2 ">
							<div class="form-group mg-b-10-force pt-4" style="margin-top: 3px;">
								<a href="{{asset('public/excel_file/election_voterlistdatafile.xlsx')}}" class="text-primary pt-4" download=""><i class="fas fa-download"></i> &nbsp;Voterlist Format</a>
							</div>
						</div><!-- col-4 -->
						<div class="col-lg-2 ">
				...
				<section>
					...
					<div class="row">
						<div class="col-lg-6">
							<div class="form-group mg-b-10-force">
								<label class="form-control-label">Ballet Paper <span class="tx-danger">*</span></label>
								<select class="form-control selectpicker" data-placeholder="Choose Ballot Type" required="" name="ballottype" id="ballottype">
									<option value="{{$singledata->ballottype}}" selected>
										@if($singledata->ballottype==1)
										Individual Majority Voting – Single Vote for Single Position (First-past-the-post)
										@endif
										@if($singledata->ballottype==2)
										Individual Majority Voting – Single Vote for Multiple Position (First-past-the-post)
										@endif
										@if($singledata->ballottype==3)
										Preferential Voting – Ranking Vote for Single Position
										@endif
										@if($singledata->ballottype==4)
										Preferential Voting – Ranking Vote for Multiple Positions in a Group Panel.
										@endif


									</option>
									<option value="1" @if($singledata->ballottype==0) selected @endif>Individual Majority Voting – Single Vote for Single Position (First-past-the-post)</option>
									<option value="2">Individual Majority Voting – Single Vote for Multiple Position (First-past-the-post)</option>
									<option value="3">Preferential Voting – Ranking Vote for Single Position</option>
									<option value="4">Preferential Voting – Ranking Vote for Multiple Positions in a Group Panel.</option>
									<option value="5" disabled>Hybrid Voting – Combination of Single Individual vote and Ranking Vote</option>
						...
						<div class="col-lg-2">
							<div class="form-group mg-b-10-force">
								...
								<button class="btn btn-success " id="open_master_model">Open Position Name Master</button>
						...
						<div class="col-lg-2">
							<div class="form-group mg-b-10-force">
								...
								<button class="btn btn-success " id="open_groupname_model">Open Group Name Master</button>
					...
					<div class="row pt-2">
						...
						<div class="col-lg-12 ">
							<div id="firstballetform">
								<form method="POST" enctype="multipart/form-data" id="add_svsp_election_form" action="javascript:void(0)">
									<input type="hidden" value="{{$singledata->id}}" name="add_svsp_election_id" id="add_svsp_election_id">
									<input type="hidden" id="ballot_type" name="ballot_type" value="1">

									<div class="row">
										<div class="col-lg-4">
											<div class="form-group mg-b-10-force">
												<label class="form-control-label">Candidate ID No <span class="tx-danger">*</span></label>
												<input id="cand_id_no1" value="" class="form-control cand_idclass" name="cand_id_no1" type="text" required="" placeholder="Enter Candidate ID No ">
										...
										<div class="col-lg-4">
											<div class="form-group mg-b-10-force">
												<label class="form-control-label">Candidate Name <span class="tx-danger">*</span></label>
												<input id="cand_id_name1" value="" class="form-control" name="cand_id_name1" type="text" required="" placeholder="Enter Candidate Name  ">
										...
										<div class="col-lg-4">
											<div class="form-group mg-b-10-force">
												...
												<input id="cand_info1" value="" class="form-control" name="cand_info1" type="text"  placeholder="Enter Candidate Information">
									...
									<div class="row pt-2">
										<div class="col-lg-4" id="canddiv1">
											<div class="form-group mg-b-10-force">
												<label class="form-control-label">Candidate Position <span class="tx-danger">*</span></label>
												<select class="form-control selectpicker " data-placeholder="Choose country" required="" name="cand_pos1" id="cand_pos1">
										...
										<div class="col-lg-4" id="canddiv2">
											<div class="form-group mg-b-10-force">
												<label class="form-control-label">Candidate Position <span class="tx-danger">*</span></label>
												<select multiple="" class="form-control selectpicker " data-placeholder="Choose country" name="cand_pos2[]" id="cand_pos2">
										...
										<div class="col-lg-4">
											<div class="form-group mg-b-10-force">
												...
												<div class="custom-file">
													<input type="file" class="custom-file-input" id="cand_photo1" name="cand_photo1" >
													<label class="custom-file-label custom-file-label-primary" for="customFile" id="candidate_photo_label">Choose file</label>
												</div><!-- custom-file -->
											</div>
										</div><!-- col-4 -->
										<div class="col-lg-4">
											<div class="form-group mg-b-10-force">
												...
												<div class="custom-file">
													<input type="file" class="custom-file-input" id="cand_electsym1" name="cand_electsym1" >
													<label class="custom-file-label custom-file-label-primary" for="customFile" id="candidate_election_symbol_label">Choose file</label>
												</div><!-- custom-file -->
											</div>
										</div><!-- col-4 -->
									</div>
									<div class="row pt-2">
										<div class="col-lg-4">
											<div class="form-group mg-b-10-force">
												...
												<select class="form-control selectpicker " data-placeholder="Choose country"  name="cand_group_name1" id="cand_group_name1">
										...
										<div class="col-lg-4">
											<div class="form-group mg-b-10-force">
												...
												<div class="custom-file">
													<input type="file" class="custom-file-input" id="cand_biodata1" name="cand_biodata1" >
													<label class="custom-file-label custom-file-label-primary" for="customFile" id="candidate_biodata_label">Choose file</label>
												</div><!-- custom-file -->
											</div>
										</div><!-- col-4 -->
										<div class="col-lg-2">
											<div class="form-group mg-b-10-force">
												...
												<button type="submit" class="btn btn-primary " id="add_election_candidate"><i class="fas fa-plus-square"></i> &nbsp;&nbsp;Add Election Candidate</button>
								...
								<p id="svsp_candidate_length_error" class="text-danger tx-14"></p>

								<div class="row pt-2">

									<div class="col-lg-12 ">
										<div class="table-wrapper">
											<table id="svsp_election_candidate_table" class="table display responsive nowrap">
												<thead>
													<tr>
				...
				<section>
					...
					<div class="section-wrapper" id="print_area">
						...
						<div class="row">
							<div class="col-lg-10">
								<p class="mg-b-20 mg-sm-b-40">Date: <span id="start_date_preview"></span> to <span id="end_date_preview"></span></p>
							</div>
							<div class="col-lg-1">
								<button class="btn btn-warning " id="print_button"><i class="fas fa-print"></i>  Print Ballot Preview</button>
							</div>
						</div>
				...
				<div class="row">
					...
					<div class="col-lg-4">
						<div class="form-group mg-b-10-force">
							...
							<input class="form-control" placeholder="Member Id No" name="voterlistmemberid_no" id="voterlistmemberid_no" type="text" required="">
					...
					<div class="col-lg-4">
						<div class="form-group mg-b-10-force">
							...
							<input class="form-control" placeholder="Additional Info" name="voterlistadditional_info" id="voterlistadditional_info" type="text" required="">
			...
			<div class="modal-body pd-25">
				<div class="row">
					...
					<div class="col-lg-4">
						<div class="form-group mg-b-10-force">
							<label class="form-control-label">Member Id No <span class="tx-danger">*</span></label>
							<input class="form-control" placeholder="Meber Id No" name="voterlistmemberid_no2" id="voterlistmemberid_no2" type="text" required="">
					...
					<div class="col-lg-4">
						<div class="form-group mg-b-10-force">
							<label class="form-control-label">Additional Info <span class="tx-danger">*</span></label>
							<input class="form-control" placeholder="Additional Info" name="voterlistadditional_info2" id="voterlistadditional_info2" type="text" required="">
				...
				<form method="POST" enctype="multipart/form-data" id="svsp_editform">
					...
					<div class="row">
						<div class="col-lg-4">
							<div class="form-group mg-b-10-force">
								<label class="form-control-label">Candidate ID No <span class="tx-danger">*</span></label>
								<input id="cand_id_no12" value="" class="form-control cand_idclass" name="cand_id_no12" type="text" required="" placeholder="Enter Candidate ID No ">
						...
						<div class="col-lg-4">
							<div class="form-group mg-b-10-force">
								<label class="form-control-label">Candidate Name <span class="tx-danger">*</span></label>
								<input id="cand_id_name12" value="" class="form-control" name="cand_id_name12" type="text" required="" placeholder="Enter Candidate Name  ">
						...
						<div class="col-lg-4">
							<div class="form-group mg-b-10-force">
								<label class="form-control-label">Candidate Information </label>
								<input id="cand_info12" value="" class="form-control" name="cand_info12" type="text"  placeholder="Enter Candidate Information">
					...
					<div class="row" >
						<div class="col-lg-4" id="canddiv12">
							<div class="form-group mg-b-10-force">
								<label class="form-control-label">Candidate Position <span class="tx-danger">*</span></label>
								<select class="form-control selectpicker " data-placeholder="Choose country" required="" name="cand_pos12" id="cand_pos12">
						...
						<div class="col-lg-4" id="canddiv22">
							<div class="form-group mg-b-10-force">
								<label class="form-control-label">Candidate Position <span class="tx-danger">*</span></label>
								<select multiple="" class="form-control selectpicker " data-placeholder="Choose country" name="cand_pos22[]" id="cand_pos22">
						...
						<div class="col-lg-4">
							<div class="form-group mg-b-10-force">
								<label class="form-control-label">Candidate Photo</label>
								<div class="custom-file">
									<input type="file" class="custom-file-input" id="cand_photo12" name="cand_photo12" >
									<label class="custom-file-label custom-file-label-primary" for="customFile" id="candidate_photo_label"><span id="editcandidatephoto_label">Choose file</span></label>
								</div><!-- custom-file -->
							</div>
						</div><!-- col-4 -->
					</div>
					<div class="row">
						<div class="col-lg-4">
							<div class="form-group mg-b-10-force">
								<label class="form-control-label">Candidate Election Symbol</label>
								<div class="custom-file">
									<input type="file" class="custom-file-input" id="cand_electsym12" name="cand_electsym12" >
									<label class="custom-file-label custom-file-label-primary" for="customFile" id="candidate_election_symbol_label"><span id="editelectionsymbol_label">Choose file</span></label>
								</div><!-- custom-file -->
							</div>
						</div><!-- col-4 -->
						...
						<div class="col-lg-4">
							<div class="form-group mg-b-10-force">
								<label class="form-control-label">Candidate Group Name </label>
								<select class="form-control selectpicker " data-placeholder="Choose Group Name"  name="cand_group_name12" id="cand_group_name12">
						...
						<div class="col-lg-4">
							<div class="form-group mg-b-10-force">
								<label class="form-control-label">Upload Bio Data File </label>
								<div class="custom-file">
									<input type="file" class="custom-file-input" id="cand_biodata12" name="cand_biodata12" >
									<label class="custom-file-label custom-file-label-primary" for="customFile" id="candidate_biodata_label"><span id="editbiodata_label">Choose File</span></label>
								</div><!-- custom-file -->
							</div>
						</div><!-- col-4 -->
					</div>
					<div class="row">
						<div class="col-lg-2">
							<div class="form-group mg-b-10-force">
								...
								<button type="submit" class="btn btn-primary add_election_candidate" id="add_election_candidate_insert"><i class="fas fa-plus-square"></i> &nbsp;&nbsp;Update </button>
...
<div id="publictypemodal" class="modal fade ">
	...
	<div id="timemodal" class="modal fade ">
		...
		<div id="position_master_model" class="modal fade ">
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content">
					...
					<div class="modal-body pd-25">
						<div class="col-lg-12">
							<input type="hidden" value="{{$singledata->id}}" id="election_id">

							<div class="row">
								<div class="col-lg-8">
									<div class="form-group mg-b-10-force">
										<label class="form-control-label">Enter Position <span class="tx-danger">*</span></label>
										<input id="position_name" class="form-control" name="position_name" required="" placeholder="Enter Position">
										<p id="position_name_mainlabel"><label class="form-control-label"> <span class="tx-danger" id="position_name_label"></span></label></p>
								...
								<div class="col-lg-3">
									...
									<button class="btn btn-success " id="add_position"><i class="fas fa-plus-square"></i> &nbsp;Add </button>
								</div>
							</div>
						</div>
						<div class="table-wrapper">
					...
					<div class="modal-body pd-25">
						<div class="col-lg-12">
							...
							<div class="row">
								<div class="col-lg-8">
									<div class="form-group mg-b-10-force">
										<label class="form-control-label">Enter Group Name <span class="tx-danger">*</span></label>
										<input id="group_name" class="form-control" name="group_name" required="" placeholder=" Group Name">
										<p id="group_name_mainlabel"><label class="form-control-label"> <span class="tx-danger" id="group_name_label"></span></label></p>
								...
								<div class="col-lg-3">
									...
									<button class="btn btn-success " id="add_groupname"><i class="fas fa-plus-square"></i> &nbsp;Add </button>
								</div>
							</div>
						</div>
						<div class="table-wrapper">
				...
				<div class="modal-content bd-0 tx-14">
					...
					<div class="modal-body pd-25">
						<h5 class="lh-3 tx-inverse text-center"><img style="height: 120px;width: 170px;" src="{{asset('public/images/icons/delete3.gif')}}" alt=""></p>
							...
							<div class="modal-footer">
								<button type="button" class="btn btn-danger deleteallvoterlist" data-dismiss="modal"><i class="fas fa-trash"></i>&nbsp;Delete</button>
								<button type="button" class="btn btn-secondary" data-dismiss="modal"><i class="fas fa-ban"></i>&nbsp;Cancel</button>
							</div>
						</div>
					</div><!-- modal-dialog -->
		...
		// 		//console.log(data);
		// 		$("#votestarttime").val(data);
		// 		$("#voteendtime").val(data);
		// 		currentime = data;
		// 		endtime = data;
		// 	}
		// });
			...
			onStepChanging: function(event, currentIndex, newIndex) {
				if (currentIndex < newIndex) {
					...
					if (currentIndex === 0) {
						...
						if (votingtitle.isValid() && entity.isValid() && voteenddate.isValid() && votestarttime.isValid() && voteendtime.isValid() && meetingdate.isValid() && votingtitle.isValid() && votingtype.isValid() && meetingtitle.isValid()) {
							//return true;
...

							{
								$.ajax({
									...
									data: {
										...
										election_status: $('#election_status').val(),
		...
		$(".updatevoterlistrecord").click(function(e) {
			...
			{
				if( $("#voterlistmemname2").val() && $("#voterlistmemberid_no2").val() && $("#voterlistmobno2").val() && $("#voterlistemail2").val() && $("#voterlistadditional_info2").val())
				{
...
var serial_no=1;
		...
		$.ajax({
			type: "get",
			url: "{{Route('getelectionvoterlistedit')}}",
			data: {election_id:getvoterlisteditid}, 
			dataType:'json',
			success:function(data) {				
				make_table(data);
				$('#voterlisteditloader').hide();
		...
		$('#ballottype').on('change', function() {
			...
			if (ballottype == 1 || ballottype == 3) {
				$('#canddiv1').show();
				$('#canddiv2').hide();


			}
			if (ballottype == 2 || ballottype == 4 ){
				$('#canddiv2').show();
				$('#canddiv1').hide();
			}
			if (ballottype == 5) {
				...
				$.ajax({
					...
					success: function(data) {
						if (data == 0) {
							...
							$("#position_name_label").text("This position is already exist");
							return;
						}
						$("#position_name").val('');
						$("#position_name_mainlabel").hide();
				...
				success: function(data) {
					...
					$.each(data, function(a, b) {
						$("#positiontablerow").append(
							'<tr><td>' + b.position + '</td><td><button class="modal-effect btn btn-danger btn-sm rounded-circle deleteposition"  id="' + b.id + '" data-toggle="tooltip-danger" title="Delete Record" data-placement="top"><i class="fas fa-trash"></i></button></td></tr>'
							);
						$("#cand_pos1").append(
				...
				success: function(data) {
					...
					$.each(data, function(a, b) {
						$("#groupnametablerow").append(
							'<tr><td>' + b.group_name + '</td><td><button class="modal-effect btn btn-danger btn-sm rounded-circle deletegroupname"  id="' + b.id + '" data-toggle="tooltip-danger" title="Delete Record" data-placement="top"><i class="fas fa-trash"></i></button></td></tr>'
							);
		...
		function ballot_preview(data)
		{
			...
			'<tr><td>' + b.candidate_id_no + '</td><td>' + b.candidate_name + '</td><td>' + b.candidate_info + '</td><td>' + b.position + '</td><td><img class="election_candidate_images" src="{{asset("public/election/svsp_election")}}/' + b.candidate_photo + '"></td><td><img class="election_candidate_images" src="{{asset("public/election/svsp_election")}}/' + b.candidate_election_symbol + '"></td><td>' + b.group_name + '</td><td><button class="btn btn-primary btn-sm rounded-circle editsvsp_candidate tooltip2" data-toggle="modal" data-effect="effect-sign" id="' + b.id + '" ><span class="tooltiptext2">Edit Record</span> <i class="fas fa-edit"></i></button> <button class="btn btn-danger btn-sm rounded-circle deletesvsp_candidate tooltip2"  id="' + b.id + '"><span class="tooltiptext2">Delete Record</span> <i class="fas fa-trash"></i></button> </td></tr>'
			);

				$("#election_candidate_preview").append('<tr class="pd-t-4">                  <td style=" border-top:1px solid  #dee2e6;" >' + b.candidate_id_no + '</td>                  <td  style=" border-top:1px solid  #dee2e6;"> <b>' + b.candidate_name + '</b><p>' + b.candidate_info + '</p></td>                  <td style=" border-top:1px solid  #dee2e6;" ">' + b.position + '</td>                  <td style=" border-top:1px solid  #dee2e6;" ><img src="{{asset("public/election/svsp_election")}}/' + b.candidate_photo + '"  alt=""></td>                  <td style=" border-top:1px solid  #dee2e6;" >' + b.group_name + '</td>                  <td style=" border-top:1px solid  #dee2e6;" ><img src="{{asset("public/election/svsp_election")}}/' + b.candidate_election_symbol + '"  alt=""></td> <td style=" padding-left:25px;padding-top:25px;"><a href="{{asset('public/election/svsp_election')}}/'+b.candidate_biodata+'" class="tx-primary tooltip2" target="_blank" download><span class="tooltiptext2">Download Biodata</span><i class="fas fa-download"></i></a></td>               </tr> ');
			});
		}
...
$.each(XL_row_object, function(a, b) {
                                       ...
                                       var ans = {           
                                       	...
                                       	parent_id: $("#electionidvoterlist").val(),                       	
                                       	type: 'election',                       	
                                       	memname:b.membername,
                                       	member_id_no:b.member_id_no,
                                       	email:b.email,
                                       	mobno:b.mobno,
