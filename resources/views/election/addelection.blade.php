					...
					<div class="row pt-2">
						<div class="col-lg-4">
							...
							<div class="form-group mg-b-10-force">
								...
								<select class="form-control select2-show-search" data-placeholder="Choose Entity" name="entity" id="entity" required="">
					...
					<div class="row ">
						<div class="col-lg-4">
							<div class="form-group mg-b-10-force">
								...
								<input class="form-control" placeholder="Enter Voting Title" name="votingtitle" id="votingtitle" type="text" required="" >
						...
						<div class="col-lg-2">
							<div class="form-group mg-b-10-force">
								...
								<input id="votestartdate" value="{{date('Y-m-d')}}" min="{{date('Y-m-d')}}" class="form-control check_time_class" name="votestartdate" type="date" required="">
						...
						<div class="col-lg-2">
							<div class="form-group mg-b-10-force">
								...
								<input id="votestarttime" value="{{$current_time}}" class="form-control check_time_class" name="votestarttime" type="time" required="">
						...
						<div class="col-lg-2">
							<div class="form-group mg-b-10-force">
								...
								<input id="voteenddate" value="{{date('Y-m-d')}}" min="{{date('Y-m-d')}}" class="form-control check_time_class" name="voteenddate" type="date" required="">
						...
						<div class="col-lg-2">
							<div class="form-group mg-b-10-force">
								...
								<input id="voteendtime" value="{{$current_time}}" class="form-control check_time_class" name="voteendtime" type="time" required="">
					...
					<div class="row">
						...
						<div class="col-lg-4">
							<div class="form-group mg-b-10-force">
								...
								<input id="meetingtitle" class="form-control" name="meetingtitle" type="text" placeholder="Enter Meeting Title" >
						...
						<div class="col-lg-4">
							<div class="form-group mg-b-10-force">
								...
								<input id="meetingdate"  value="{{date('Y-m-d')}}" class="form-control" name="meetingdate" type="date" >
					...
					<div class="row">
						<div class="col-lg-6">
							<div class="form-group mg-b-10-force">
								...
								<select class="form-control selectpicker" data-placeholder="Choose country" required="" name="ballottype" id="ballottype">
									<option value="1" selected>Individual Majority Voting – Single Vote for Single Position (First-past-the-post)</option>
									...
									<option value="5">Hybrid Voting – Combination of Single Individual vote and Ranking Vote</option>
			...
			<div class="modal-body pd-25">
				<div class="row">
					...
					<div class="col-lg-4">
						<div class="form-group mg-b-10-force">
							<label class="form-control-label">Member Id No <span class="tx-danger">*</span></label>
							<input class="form-control" placeholder="Member Id No" name="voterlistmemberid_no2" id="voterlistmemberid_no2" type="text" required="">
...

							{
								...
								$.ajax({
									...
									success: function(data) {
										...
										$('#ibcidlabel1').text('Election Voting Id : ' + data.electionid);
										$('#ibcidlabel2').text('Election Voting Id : ' + data.electionid);
										$('#ibcidlabel3').text('Election Voting Id : ' + data.electionid);
										$('#ibcidlabel4').text('Election Voting Id : ' + data.electionid);
