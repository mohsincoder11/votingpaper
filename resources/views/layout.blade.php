...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('public/css/slim.css') }}?v={{ date('YmdHis') }}">
            ...
            <div class="slim-header-right">
                ...
                <div class="dropdown dropdown-c">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <nav class="nav">
                            <a href="" class="nav-link"><i class="fas fa-user-circle"></i> &nbsp; View
                                Profile</a>
                            <a href="" class="nav-link"><i class="fas fa-user-edit"></i> &nbsp; Edit Profile</a>
                            <a href="{{ route('notification') }}" class="nav-link"><i class="fas fa-paper-plane"></i>
                                &nbsp; Send Notification</a>
                            <a href="" class="nav-link"><i class="fas fa-user-cog"></i> &nbsp; Account
                                Settings</a>
                            <a href="{{ route('signout') }}" class="nav-link"><i class="fas fa-sign-out-alt"></i>
                                &nbsp; Sign Out</a>
                        </nav>
                    </div><!-- dropdown-menu -->
                </div><!-- dropdown -->
            ...
            <ul class="nav">
                ...
                @if (auth()->user()->role == 1 || auth()->user()->role == 2)
                    <li class="nav-item with-sub" id="entitytab">
                        ...
                        <div class="sub-item">
                            <ul>
                                <li><a href="{{ route('addentity') }}"><i
                                            class="fas fa-plus-square"></i>&nbsp;&nbsp;&nbsp;&nbsp;Add Entity</a></li>
                                <li><a href="{{ route('addedentity') }}"><i
                                            class="fas fa-eye"></i>&nbsp;&nbsp;&nbsp;Registered Entity</a></li>
                            </ul>
                        </div><!-- dropdown-menu -->
                    </li>
                @endif
                ...
                <li class="nav-item with-sub" id="electiontab">
                    ...
                    <div class="sub-item">
                        <ul>
                            <li><a href="{{ route('addelection') }}"><i
                                        class="fas fa-plus-square"></i>&nbsp;&nbsp;&nbsp;&nbsp;Create Poll</a></li>
                            <li><a href="{{ route('addedelection') }}"><i
                                        class="fas fa-eye"></i>&nbsp;&nbsp;&nbsp;&nbsp;Registered Poll</a></li>
                            <!--                 <li><a href=""><i class="fas fa-file-medical"></i>&nbsp;&nbsp;&nbsp;&nbsp;Voting Status</a></li>
 -->
                            <li><a href="{{ route('live_election') }}"><i
                                        class="fas fa-chart-line"></i>&nbsp;&nbsp;&nbsp;&nbsp;Live Election</a></li>
                            <li><a href="{{ route('election_result') }}"><i
                                        class="fas fa-file-alt"></i>&nbsp;&nbsp;&nbsp;&nbsp;Result</a></li>
                        </ul>
                    </div><!-- dropdown-menu -->
                </li>
                <li class="nav-item with-sub" id="ibcvotingtab">
                    ...
                    <div class="sub-item">
                        <ul>
                            <li><a href="{{ route('addibc') }}"><i
                                        class="fas fa-plus-square"></i>&nbsp;&nbsp;&nbsp;&nbsp;Create Poll</a></li>
                            <li><a href="{{ route('addedibc') }}"><i
                                        class="fas fa-eye"></i>&nbsp;&nbsp;&nbsp;&nbsp;Registered Poll</a></li>
                            <li><a href="{{ route('live_ibc_voting') }}"><i
                                        class="fas fa-chart-line"></i>&nbsp;&nbsp;&nbsp;&nbsp;Live Voting </a></li>
                            <li><a href="{{ route('ibc_result') }}"><i
                                        class="fas fa-list-alt"></i>&nbsp;&nbsp;&nbsp;&nbsp;Results</a></li>
                ...
                <li class="nav-item with-sub" id="surveytab">
                    ...
                    <div class="sub-item">
                        <ul>
                            <li><a href="{{ route('add_survey') }}"><i
                                        class="fas fa-plus-square"></i>&nbsp;&nbsp;&nbsp;&nbsp;Add Survey</a></li>
                            <li><a href="{{ route('added_survey') }}"><i
                                        class="fas fa-eye"></i>&nbsp;&nbsp;&nbsp;Added Survey</a></li>
                            <li><a href="{{ route('live_survey') }}"><i
                                        class="fas fa-chart-line"></i>&nbsp;&nbsp;&nbsp;Live Survey</a></li>
                            <li><a href="{{ route('survey_result') }}"><i
                                        class="fas fa-file-alt"></i>&nbsp;&nbsp;&nbsp;&nbsp;Result</a></li>
