...
<body>
    ...
    <input type="hidden" value="{{ auth()->user()->memname }}" id="user_nameinput">
    <input type="hidden" value="{{ auth()->user()->entityid }}" id="entityid">
    <input type="hidden" value="{{ auth()->user()->mobno }}" id="mobno">
    <input type="hidden" value="{{ auth()->user()->id }}" id="user_id">

    <div class="slim-header ">
        <div class="container">
            <div class="slim-header-left">
                <h2 class="slim-logo"><a href="{{ route('user_dashboard') }}">VOTING PAPER<span>.</span></a></h2>
            ...
            <div class="slim-header-right">
                  ...
                  <a href="#">Settings</a> -->
                        ...
                        <div class="dropdown-list">
                            ...
                            <div class="dropdown-list-footer">
                                <a href="#" id="show_all_notification"><i class="fa fa-angle-down"></i> Show All
                                    Notifications</a>
                            </div>
                        </div><!-- dropdown-list -->
                ...
                <div class="dropdown dropdown-c">
                    <a href="#" class="logged-user" data-toggle="dropdown">
                        ...
                        <span>{{ strtoupper(auth()->user()->memname) }}</span>
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <nav class="nav">
                            ...
                            <a href="{{ route('user_feedback') }}" class="nav-link"><i class="fas fa-comments"></i>
                                &nbsp; User Feedback </a>
                            <a href="" class="nav-link"><i class="fas fa-user-cog"></i> &nbsp; Account
                                Settings</a>
                            <a href="{{ route('user_signout') }}" class="nav-link"><i class="fas fa-sign-out-alt"></i>
                                &nbsp; Sign Out</a>
                        </nav>
                    </div><!-- dropdown-menu -->
                </div><!-- dropdown -->
        ...
        <div class="container">
            <ul class="nav">
                ...
                <li class="nav-item " id="electiontab">
                    <a class="nav-link" href="{{ route('electiondetails') }}">
                        <i class="fas fa-vote-yea"></i> &nbsp;&nbsp;
                        <span>Election</span>
                    </a>
                </li>
                <li class="nav-item " id="ibcvotingtab">
                    <a class="nav-link" href="{{ route('ibcdetails') }}">
                        <i class="fas fa-poll"></i> &nbsp;&nbsp;
                        <span>IBC Voting</span>
                    </a>
                </li>
                <li class="nav-item " id="surveytab">
                    <a class="nav-link" href="{{ route('surveydetails') }}">
    ...
    <script>
        $("document").ready(function() {
            ...
            $("#notification_bell").on('click', function() {
                ...
                $.ajax({
                    type: "GET",
                    url: '{{route("get_alluser_notification")}}', // Update the URL to include the '/api' prefix
                    data: {
                        ...
                        if (data.length > 0) {
                            $.each(data, function(a, b) {
                                ...
                                $("#notification_list").append(
                                    '<a href="#" class="dropdown-link"><div class="media"><img src="{{ asset('public/images/icons/vicon5.png') }}" alt=""><div class="media-body"><p><strong>' +
                                    b.title + '</strong> : ' + b.message +
                                    '</strong></p><span> ' + b.created_date + '  ' +
                                    b.created_time + '</span></div></div></a>');
                            })
                        } else {
                            $("#notification_list").html(
                                "<p></p><h5 class='tx-center'>&nbsp;You don't have any notification.</h5>"
                                );
                        }
