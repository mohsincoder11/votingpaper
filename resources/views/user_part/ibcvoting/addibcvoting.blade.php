        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between pd-y-5 bd-b">
              ...
              @else {{$ibc->resdescription}} 
              @endif</h6>
              <div class="card-option tx-24">
                <a href="{{asset('public/resolution/'.$ibc->resolutiondetail)}}"  class="tx-primary tooltip2" target="_blank" download><span class="tooltiptext2">Download Description File</span><i class="fas fa-download"></i></a>
              </div><!-- card-option -->
            </div><!-- card-header -->
            <div class="card-body">
            ...
            <div class="card-footer bd-t ">
              @if($ibc->resulttype=='yn')
               <div class="row">
                ...
                <input type="radio" name="{{$ibc->id}}" value="yes"><span>Yes</span>
              </label> 
             </div><!-- btn-demo -->
                         <div class="col-sm-2 col-md-2">
                            
                <label class="rdiobox rdiobox-danger mg-t-5">
                <input type="radio" name="{{$ibc->id}}" value="no"><span>No</span>
              </label>
                            </div><!-- btn-demo -->
                              <div class="col-sm-2 col-md-2">
                            
                <label class="rdiobox rdiobox-warning mg-t-5">
                <input type="radio" name="{{$ibc->id}}" value="abstained"><span>Abstained</span>
              </label>
                            </div><!-- btn-demo -->
              ...
              @if($ibc->resulttype=='ad')
                <div class="row">
                        ...
                        <div class="col-sm-2 col-md-2">
                             <label class="rdiobox rdiobox-success mg-t-5">
                <input type="radio" name="{{$ibc->id}}" value="favor"><span>Favor</span>
              </label> 
             </div><!-- btn-demo -->
                         <div class="col-sm-2 col-md-2">
                            
                <label class="rdiobox rdiobox-danger mg-t-5">
                <input type="radio" name="{{$ibc->id}}" value="against"><span>Against</span>
              </label>
                            </div><!-- btn-demo -->
                              <div class="col-sm-2 col-md-2">
              ...
              @if($ibc->resulttype=='ar')
               <div class="row">
                        ...
                        <div class="col-sm-2 col-md-2">
                             <label class="rdiobox rdiobox-success mg-t-5">
                <input type="radio" name="{{$ibc->id}}" value="accept"><span>Accept</span>
              </label> 
             </div><!-- btn-demo -->
                         <div class="col-sm-2 col-md-2">
                            
                <label class="rdiobox rdiobox-danger mg-t-5">
                <input type="radio" name="{{$ibc->id}}" value="reject"><span>Reject</span>
              </label>
                            </div><!-- btn-demo -->
                              <div class="col-sm-2 col-md-2">
...
ans_array[i] = ans;
  ...
  $.ajax({
      type: "POST",
          // url: '/votingpaper2410/votingpaper/api/insert_resolution_ans',
