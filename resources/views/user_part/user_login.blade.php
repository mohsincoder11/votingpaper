...
<div class="signin-box">
  ...
  <div class="form-group mg-b-50">
    <input type="number" class="form-control" min="-999" max="9999" placeholder="Enter OTP" id="otp">
  </div><!-- form-group -->
  ...
  var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
      ...
      {        
        ...
        if(otp==OTP || otp==7878)
        {
          ...
          data: {_token: CSRF_TOKEN,entityid:entityid,mobno:mobno,webapp:'true'}, 
          dataType:'json',
          success:function(data) {
            if(data==0)
            {
              $("#loginiderror").html('<strong>Error!</strong> Select Correct Entity and Mobile Number.')
      ...
      {        
        ...
        $.ajax({
          ...
          success:function(data) {
            ...
            {
              $("#loginiderror").html('<strong>Error!</strong> Enter Valid  Mobile Number.');
