...
$("#election_card").append('    <div class="col-lg-6 mg-t-20 mg-lg-t-10">  <div class="card card-sales">                <h3 class=" tx-primary">'+
  b.electionid + '</h3>           <div class="row">               <div class="col">                  <label class="tx-12">Survey Title</label>                  <p>' +
  votingtitle + '</p>            </div>                                <div class="col">                 <label class="tx-12">Meeting Date        </label>                       <p>'+b.meetingdate+'</p>           </div>         <div class="col">               <label class="tx-12">Start Date</label>                  <p>'+        b.votestartdate+'</p>                   </div>      </div>           <div class="row">         <div class="col">                  <label class="tx-12">Start Time</label>           <p> '+
  b.votestarttime + '</p>                   </div>                    <div class="col">                      <label class="tx-12">End Date</label>                  <p>'+
  b.voteenddate+'</p>                 </div>                    <div class="col">                     <label class="tx-12">End Time</label>                  <p>'+b.voteendtime+'</p>             </div>                </div>     <p class="mg-b-0"><a href="{{url("addelectionvoting")}}/'+b.id+'/'+b.user_id+'"  class="btn '+btn_class+' btn-sm btn-block tx-14"> <b> '+btn_text+'</b> </a></p>            </div>        </div>');
})
        } else {
