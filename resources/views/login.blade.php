    ...
    <div class="signin-box">
      ...
      <form  id="form" >
        ...
        <div class="form-group">
          <input type="text" class="form-control" placeholder="Enter Username" id="username" autocomplete="off" required="">
        </div><!-- form-group -->
        <div class="form-group mg-b-20">
          <input type="password" class="form-control" placeholder="Enter Password" id="password" autocomplete="off" required="">
        </div><!-- form-group -->
