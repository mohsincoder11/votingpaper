                    ...
                    <div class="card card-quick-post mg-t-10">
                        <div class="row">
                            <div class="col-md-3" id="entitydiv">
                                ...
                                <select class="form-control select2-show-search" data-placeholder="Select Entity"
                                    id="entity_list" required>

                                </select>
                            </div>
                            <div class="col-md-3" id="userdiv">
                                <label class="form-control-label">Select User <span class="tx-danger">*</span></label>
                                <select class="form-control select2-show-search " multiple data-placeholder="Select User"
                            ...
                            <div class="col-lg-3" id="otherinput">
                                <div class="form-group mg-b-10-force">
                                    ...
                                    <input class="form-control" value="" placeholder="Title" name="title"
                                        id="title" required>
        ...
        <div class="modal-dialog modal-dialog-vertical-center" role="document">
            <div class="modal-content bd-0 tx-14">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger delete_model_btn" data-dismiss="modal"><i
        ...
        $(document).ready(function() {
            ...
            $("#submit_btn").on('click', function(e) {
                ...
                if ($("#inputmode").val() == 'insert') {
                    if ($("#entity_list").val() == '' || $("#title").val() == '' || $("#message").val() ==
                        '' || $("#user").val() == '' || $("#user").val() == null) {
            ...
            function get_all_notification() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $.each(data, function(a, b) {
                            $("#notification_table_row").append(' <tr><td>' + b.id +
                                '</td><td>' + b.noofuser + '</td><td>' + b.title +
                                '</td><td>' + b.message +
                                '</td><td><a class="btn btn-sm rounded-circle btn-info modal-effect viewbutton tooltip2" id="' +
                                b.id +
                                '" href="#viewmodal" data-toggle="modal" data-effect="effect-sign "><span class="tooltiptext2">View Record</span><i class="fas fa-eye"></i></a> <button class="btn btn-sm rounded-circle btn-warning editbutton tooltip2" id="' +
                                b.id +
                                '" ><span class="tooltiptext2">Edit Record</span><i class="fas fa-edit"></i></button> <a href="#deletemodalcall" class="modal-effect btn btn-danger btn-sm rounded-circle delete_notification tooltip2" data-toggle="modal" data-effect="effect-sign" id=' +
                                b.id +
            ...
            $("#notification_table tbody").on('click', '.viewbutton', function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $.each(data, function(a, b) {
                            $("#notificaton_list").append('<tr><td>' + b.memname +
                                '</td><td>' + b.title + '</td><td>' + b.message +
                                '</td><td><button class="btn btn-danger btn-sm rounded-circle deleterow" id="' +
                                b.id +
